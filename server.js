...
client.on("reconnect", () => console.log("Reconectando..."));
  ...
  token: "NTc5NjI3MjA1MzIwMTE0MTc2.XOFMww.zviIKZVZIqjOatYv3KcGe8Vq_w8", 
  comandos: "./comandos", 
  eventos: "./eventos"
  });
...
client.on('message', message => {
  ...
  client.user.setActivity(`brigade!help | Funcionando en 189 servidores :D`);
});
...
client.login('NTc5NjI3MjA1MzIwMTE0MTc2.XOFMww.zviIKZVZIqjOatYv3KcGe8Vq_w8');
